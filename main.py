...
jan1 = round((1 + ((m1r1+interest)/1200)) * loanamount - rate, 2)
print((left), str(jan1), ",wchich is:", round((loanamount - jan1), 2), (less))

feb1 = round((1 + ((m2r1+interest)/1200)) * jan1 - rate, 2)
print((left), str(feb1), ",wchich is:", round((jan1 -feb1), 2), (less))

mar1 = round((1 + ((m3r1+interest)/1200)) * feb1 - rate, 2)
print((left), str(mar1), ",wchich is:", round((feb1 -mar1), 2), (less))

apr1 = round((1 + ((m4r1+interest)/1200)) * mar1 - rate, 2)
print((left), str(apr1), ",wchich is:", round((mar1 -apr1), 2), (less))

may1 = round((1 + ((m5r1+interest)/1200)) * apr1 - rate, 2)
print((left), str(may1), ",wchich is:", round((apr1 -may1), 2), (less))

jun1 = round((1 + ((m6r1+interest)/1200)) * may1 - rate, 2)
print((left), str(jun1), ",wchich is:", round((may1 -jun1), 2), (less))

jul1 = round((1 + ((m7r1+interest)/1200)) * jun1 - rate, 2)
print((left), str(jul1), ",wchich is:", round((jun1 -jul1), 2), (less))

aug1 = round((1 + ((m8r1+interest)/1200)) * jul1 - rate, 2)
print((left), str(aug1), ",wchich is:", round((jul1 -aug1), 2), (less))

sep1 = round((1 + ((m9r1+interest)/1200)) * aug1 - rate, 2)
print((left), str(sep1), ",wchich is:", round((aug1 -sep1), 2), (less))

oct1 = round((1 + ((m10r1+interest)/1200)) * sep1 - rate, 2)
print((left), str(oct1), ",wchich is:", round((sep1 -oct1), 2), (less))

nov1 = round((1 + ((m11r1+interest)/1200)) * sep1 - rate, 2)
print((left), str(nov1), ",wchich is:", round((sep1 -nov1), 2), (less))

dec1 = round((1 + ((m12r1+interest)/1200)) * nov1 - rate, 2)
print((left), str(dec1), ",wchich is:", round((nov1 -dec1), 2), (less))

# second year

sty2 = round((1 + ((m1r2+interest)/1200)) * dec1 - rate, 2)
print((left), str(sty2), ",wchich is:", round((dec1 - sty2), 2), (less))
...
print((left), str(nov2), ",wchich is:", round((paz2 -nov2), 2), (less))

dec2 = round((1 + ((m12r2+interest)/1200)) * nov2 - rate, 2)
print((left), str(dec2), ",wchich is:", round((nov2 -dec2), 2), (less))
