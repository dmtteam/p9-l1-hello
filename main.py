...
print((left), str(sty1), "to o:", round((loanamount - sty1), 2), (less))

lut1=round((1 + ((m2r1+interest)/1200)) * sty1 - rate, 2)
print((left), str(lut1), "to o:", round((sty1 -lut1), 2), (less))

mar1=round((1 + ((m3r1+interest)/1200)) * lut1 - rate, 2)
print((left), str(mar1), "to o:", round((lut1 -mar1), 2), (less))

kwi1=round((1 + ((m4r1+interest)/1200)) * mar1 - rate, 2)
print((left), str(kwi1), "to o:", round((mar1 -kwi1), 2), (less))

maj1=round((1 + ((m5r1+interest)/1200)) * kwi1 - rate, 2)
print((left), str(maj1), "to o:", round((kwi1 -maj1), 2), (less))

cze1=round((1 + ((m6r1+interest)/1200)) * maj1 - rate, 2)
print((left), str(cze1), "to o:", round((maj1 -cze1), 2), (less))

lip1=round((1 + ((m7r1+interest)/1200)) * cze1 - rate, 2)
print((left), str(lip1), "to o:", round((cze1 -lip1), 2), (less))

sie1=round((1 + ((m8r1+interest)/1200)) * lip1 - rate, 2)
print((left), str(sie1), "to o:", round((lip1 -sie1), 2), (less))

wrz1=round((1 + ((m9r1+interest)/1200)) * sie1 - rate, 2)
print((left), str(wrz1), "to o:", round((sie1 -wrz1), 2), (less))

paz1=round((1 + ((m10r1+interest)/1200)) * wrz1 - rate, 2)
print((left), str(paz1), "to o:", round((wrz1 -paz1), 2), (less))

lis1=round((1 + ((m11r1+interest)/1200)) * paz1 - rate, 2)
print((left), str(lis1), "to o:", round((paz1 -lis1), 2), (less))

gru1=round((1 + ((m12r1+interest)/1200)) * lis1 - rate, 2)
print((left), str(gru1), "to o:", round((lis1 -gru1), 2), (less))

# second year

sty2=round((1 + ((m1r2+interest)/1200)) * gru1 - rate, 2)
print((left), str(sty2), "to o:", round((gru1 - sty2), 2), (less))

lut2=round((1 + ((m2r2+interest)/1200)) * sty2 - rate, 2)
print((left), str(lut2), "to o:", round((sty2 -lut2), 2), (less))

mar2=round((1 + ((m3r2+interest)/1200)) * lut2 - rate, 2)
print((left), str(mar2), "to o:", round((lut2 -mar2), 2), (less))

kwi2=round((1 + ((m4r2+interest)/1200)) * mar2 - rate, 2)
print((left), str(kwi2), "to o:", round((mar2 -kwi2), 2), (less))

maj2=round((1 + ((m5r2+interest)/1200)) * kwi2 - rate, 2)
print((left), str(maj2), "to o:", round((kwi2 -maj2), 2), (less))

cze2=round((1 + ((m6r2+interest)/1200)) * maj2 - rate, 2)
print((left), str(cze2), "to o:", round((maj2 -cze2), 2), (less))

lip2=round((1 + ((m7r2+interest)/1200)) * cze2 - rate, 2)
print((left), str(lip2), "to o:", round((cze2 -lip2), 2), (less))

sie2=round((1 + ((m8r2+interest)/1200)) * lip2 - rate, 2)
print((left), str(sie2), "to o:", round((lip2 -sie2), 2), (less))

wrz2=round((1 + ((m9r2+interest)/1200)) * sie2 - rate, 2)
print((left), str(wrz2), "to o:", round((sie2 -wrz2), 2), (less))

paz2=round((1 + ((m10r2+interest)/1200)) * wrz2 - rate, 2)
print((left), str(paz2), "to o:", round((wrz2 -paz2), 2), (less))

lis2=round((1 + ((m11r2+interest)/1200)) * paz2 - rate, 2)
print((left), str(lis2), "to o:", round((paz2 -lis2), 2), (less))

gru2=round((1 + ((m12r2+interest)/1200)) * lis2 - rate, 2)
print((left), str(gru2), "to o:", round((lis2 -gru2), 2), (less))
